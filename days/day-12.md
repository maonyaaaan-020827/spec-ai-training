...
# training/day-12 は用意済み。なければ: mkdir -p training/day-12
ls training/day-12
```

**ファイルの作り方:**
- ターミナルで `open training/day-12` を実行すると Finder でフォルダが開く
- 方法1: Finder 上でテキストエディット等を使いファイルを作成し、ファイル名を `project-b-requirements.md` にして保存
