...
> Cursor でフォルダを開くと、そのフ��ルダ内のすべてのファイルをサイドバーから簡単に行き来できる。

### ファイルの作成と編集

**新しいファイルを作成する:**
1. サ���ドバーで作成したいフォルダを右クリック → **「New File」**
...
- このターミナルは、開いているフォルダがカレントディレ��トリになっている

> Day4 以降��� Git 操作は、Cursor 内のターミナルで実行するとフォルダ移動が不要で便利。
